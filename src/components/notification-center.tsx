...
const notifications: Notification[] = [
  {
    id: 1,
    type: "success",
    message: __("Operation completed successfully!", "wpstorm-clean-admin"),
  },
  {
    id: 2,
    type: "error",
    message: __("An error occurred during processing", "wpstorm-clean-admin"),
  },
  {
    id: 3,
    type: "warning",
    message: __("Warning: Check your settings", "wpstorm-clean-admin"),
  },
  {
    id: 4,
    type: "info",
    message: __("Information: New update available", "wpstorm-clean-admin"),
  },
];
    ...
    <Popover>
      <PopoverTrigger>
        <button
          ...
          aria-label={__("Open notifications", "wpstorm-clean-admin")}
        >
      ...
      >
        <div className="p-4 border-b text-sm font-semibold">
          {__("Notifications", "wpstorm-clean-admin")}
        </div>
        ...
        <div className="p-3 border-t text-xs text-center text-muted-foreground cursor-pointer hover:text-primary">
          {__("View all", "wpstorm-clean-admin")}
        </div>
      </PopoverContent>
    </Popover>
  );
