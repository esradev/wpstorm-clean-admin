    ...
    <>
      <div>
        ...
        >
          ...
          {__('Section doc', 'storm-clean-admin')}
        </Button>
      </div>
      {isInfoOpen && (
        <div
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mr-4 sm:mt-0 sm:text-right">
                    ...
                    <div className="mt-2 text-sm text-gray-500">
                      ...
                      <a
                        href={route?.infoLink.url}
                        className="text-fuchsia-600 px-2 py-1 rounded-md hover:bg-fuchsia-100 hover:no-underline ease-in-out transition-all duration-500"
                        target="_blank"
                      >
